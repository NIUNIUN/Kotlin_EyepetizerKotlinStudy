 ...
 */
class HotMouthFragment :BaseFragment<IRankView, RankPresenter>(), IRankView {
    ...
    override fun getLayoutId(): Int {
        return R.layout.fragment_hot_rank_mouth
    }
    ...
    override fun initViews() {
        ...
        mRvData = mActivity.findViewById(R.id.rv_rank_data_mouth)
    ...
    companion object {
        ...
        fun getInstance(apiUri: String): HotMouthFragment {
            var hotMouthFragment = HotMouthFragment()
            var bundle: Bundle = Bundle()
            bundle.putString(EXTRA_DATA, apiUri)
            hotMouthFragment.arguments = bundle
