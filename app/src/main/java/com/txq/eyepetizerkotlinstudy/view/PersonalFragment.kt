...
import com.txq.eyepetizerkotlinstudy.ui.CameraDialogFragment
import com.txq.base.utils.CameraUtils
import com.txq.base.utils.LogUtils
import com.txq.eyepetizerkotlinstudy.utils.SharedPreferenceUtils
...
//                }
    ...
    companion object {
        ...
        fun getInstance(): PersonalFragment {
            LogUtils.d("创建对象 PersonalFragment")
